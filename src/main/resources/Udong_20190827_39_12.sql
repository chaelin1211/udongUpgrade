...
ALTER TABLE CLUB
ADD CONSTRAINT FK_CLUB_USER_ID_MEMBER_USER_ID FOREIGN KEY (USER_ID)
...
-- GRADE 1: GENERAL USER, 2: ADMIN
    `GRADE`      INT                        COMMENT '등급' DEFAULT 2,
    PRIMARY KEY(USER_ID)
);
...
( 
    `USER_ID`       VARCHAR(45)     NOT NULL     COMMENT '멤버 아이디'
    `CLUB_NUM`      INT             NOT NULL     COMMENT '클럽 번호', 
    PRIMARY KEY (USER_ID, CLUB_NUM)
);
...
REFERENCES CLUB (CLUB_NUM) ON DELETE CASCADE;

ALTER TABLE CLUB_MEMBER
ADD CONSTRAINT FK_CLUB_MEMBER_USER_ID_MEMBER_EM FOREIGN KEY (USER_ID)
...
(
    ...
    PRIMARY KEY (USER_ID, INTEREST_NUM)
);

ALTER TABLE MEMBER_INTEREST COMMENT '멤버흥미';

ALTER TABLE MEMBER_INTEREST
ADD CONSTRAINT FK_MEMBER_INTEREST_USER_ID_MEMBE FOREIGN KEY (USER_ID)
REFERENCES MEMBER (USER_ID) ON DELETE CASCADE;

ALTER TABLE MEMBER_INTEREST
ADD CONSTRAINT FK_MEMBER_INTEREST_INTEREST_NUM_INTEREST_INTEREST_NUM FOREIGN KEY (INTEREST_NUM)
REFERENCES INTEREST_CATEGORY (INTEREST_NUM) ON DELETE CASCADE;
...
(
    ...
    `USER_ID`         VARCHAR(45)    NOT NULL     COMMENT '작성자 아이디',
...
ALTER TABLE BOARD
ADD CONSTRAINT FK_BOARD_USER_ID_MEMBER_USER_ID FOREIGN KEY (USER_ID)
REFERENCES MEMBER (USER_ID);

ALTER TABLE BOARD
ADD CONSTRAINT FK_BOARD_CATEGORY_NUM_CATEGORY_CATEGORY_NUM FOREIGN KEY (CATEGORY_NUM)
...
ALTER TABLE FAQ
ADD CONSTRAINT FK_FAQ_USER_ID_MEMBER_USER_ID FOREIGN KEY (USER_ID)
REFERENCES MEMBER (USER_ID);
...
ALTER TABLE QNA
ADD CONSTRAINT FK_QNA_USER_ID_MEMBER_USER_ID FOREIGN KEY (USER_ID)
REFERENCES MEMBER (USER_ID);
...
ALTER TABLE COMMENT
ADD CONSTRAINT FK_COMMENT_POST_NUM_BOARD_POST_NUM FOREIGN KEY (POST_NUM)
REFERENCES BOARD (POST_NUM) ON DELETE CASCADE;

ALTER TABLE COMMENT
ADD CONSTRAINT FK_COMMENT_USER_ID_MEMBER_USER_ID FOREIGN KEY (USER_ID)
REFERENCES MEMBER (USER_ID) ON DELETE CASCADE;
...
ADD CONSTRAINT FK_RECOMMEND_USER_ID_MEMBER_USER_ID FOREIGN KEY (USER_ID)
REFERENCES MEMBER (USER_ID) ON DELETE CASCADE;

ALTER TABLE RECOMMEND
ADD CONSTRAINT FK_RECOMMEND_POST_NUM_BOARD_POST_NUM FOREIGN KEY (POST_NUM)
REFERENCES BOARD (POST_NUM) ON DELETE CASCADE;
...
-- REFERENCES AREA (AREA_NUM) ON DELETE CASCADE;