...
INSERT INTO AREA (AREA_NAME) VALUES ('경북');
INSERT INTO AREA (AREA_NAME) VALUES ('전남');
INSERT INTO AREA (AREA_NAME) VALUES ('전북');

INSERT INTO INTEREST_CATEGORY (INTEREST_NAME) VALUES ('요리');
INSERT INTO INTEREST_CATEGORY (INTEREST_NAME) VALUES ('친목');
INSERT INTO INTEREST_CATEGORY (INTEREST_NAME) VALUES ('교양');
INSERT INTO INTEREST_CATEGORY (INTEREST_NAME) VALUES ('문화');
INSERT INTO INTEREST_CATEGORY (INTEREST_NAME) VALUES ('운동');
INSERT INTO INTEREST_CATEGORY (INTEREST_NAME) VALUES ('정치');
INSERT INTO INTEREST_CATEGORY (INTEREST_NAME) VALUES ('여행');
INSERT INTO INTEREST_CATEGORY (INTEREST_NAME) VALUES ('코딩');
INSERT INTO INTEREST_CATEGORY (INTEREST_NAME) VALUES ('공연');
INSERT INTO INTEREST_CATEGORY (INTEREST_NAME) VALUES ('취업');
...
-- INSERT INTO CLUB (CLUB_NAME, INTRO, AREA_NUM, CONTENT, EMAIL, INTEREST_NUM) VALUES ('교양을 먹고 살다', '음악,미술,문학,역사,종교 교양 공유', '경상도', '교양', '134eageng', 03, '교양', 59);
-- INSERT INTO CLUB (CLUB_NAME, INTRO, AREA_NUM, CONTENT, EMAIL, INTEREST_NUM) VALUES ('정치 토론회 클래스', '논리에 기반한 정치 토론회', '부산광역시', '정치', 'beachsolo', 04, '정치', 202);
-- INSERT INTO CLUB (CLUB_NAME, INTRO, AREA_NUM, CONTENT, EMAIL, INTEREST_NUM) VALUES ('노력하는 춤꾼들', '춤추고 배우는 모임', '전라도', '문화', 'sokd22', 05, '문화', 102);
-- INSERT INTO CLUB (CLUB_NAME, INTRO, AREA_NUM, CONTENT, EMAIL, INTEREST_NUM) VALUES ('산을 타는 사람들', '등산 모임', '충청도', '운동', 'vivi292', 06, '운동', 77);
-- INSERT INTO CLUB (CLUB_NAME, INTRO, AREA_NUM, CONTENT, EMAIL, INTEREST_NUM) VALUES ('시네마 천국', '영화 동반 관람', '충청도', '문화', '11lalasweet', 07, '문화', 788);
-- INSERT INTO CLUB (CLUB_NAME, INTRO, AREA_NUM, CONTENT, EMAIL, INTEREST_NUM) VALUES ('슈퍼카스', '슈퍼카 동호회', '서울특별시', '친목', 'goback', 08, '친목', 13);
-- INSERT INTO CLUB (CLUB_NAME, INTRO, AREA_NUM, CONTENT, EMAIL, INTEREST_NUM) VALUES ('아쿠아리움', '물고기 키우는 사람들', '경기도', '친목', 'gangg20', 09, '친목', 27);
-- INSERT INTO CLUB (CLUB_NAME, INTRO, AREA_NUM, CONTENT, EMAIL, INTEREST_NUM) VALUES ('고양이 집사 모임', '애묘인의 모임', '경상도', '친목', 'pjm339', 10, '친목', 343);
-- INSERT INTO CLUB (CLUB_NAME, INTRO, AREA_NUM, CONTENT, EMAIL, INTEREST_NUM) VALUES ('밀덕스', '밀리터리 애호가 모임', '강원도', '문화', 'pipi334', 11, '문화', 91);
-- INSERT INTO CLUB (CLUB_NAME, INTRO, AREA_NUM, CONTENT, EMAIL, INTEREST_NUM) VALUES ('이터널 메호대전', '축구를 사랑하는 모임', '강원도', '운동', 'choboda40', 12, '운동', 741);
...
INSERT INTO BOARD (CATEGORY_NUM, TIME, TITLE, CONTENT, EMAIL) VALUES (1, NOW(), '영자 일 안함?', '밑에 맨날 vs로 어그로 끄는 놈 정지 안 시킴?', 'test@naver.com');
